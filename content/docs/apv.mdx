...
4. Scammen is alleen toegestaan onder de volgende voorwaarden:
    * De scam heeft uitsluitend betrekking op **illegale goederen**.
    * Bij de scam moet **een wapen betrokken zijn**.
    * De scam moet plaatsvinden binnen een **roleplay-scenario**.
    * **Hands up is verplicht** bij het uitvoeren van de scam.
    * Het scammen op items uit de /store is niet toegestaan.
    * Spelers die **minder dan 48 uur** op de server zijn, mogen niet worden gescamd. Deze spelers zijn herkenbaar aan het **blaadje naast hun ID**.
    * De maximale totale waarde van een scam bedraagt **€2.000.000**. Hierbij wordt de totale waarde van zowel geld als goederen meegerekend.
    * Voorbeeld: A verkoopt een wapen aan B. B ript A van het wapen, of A ript het wapen terug met behulp van anderen. Hierbij moet aan bovenstaande voorwaarden worden voldaan.
