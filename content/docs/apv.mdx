...
1. Je krijgt per hostage 1 eis. Er geldt een maximum van 6 eisen bij een overval.
2. Het is niet toegestaan om hostages te pakken op de volgende plekken:
    ...
    - Personeel van een officieel bedrijf binnen Springbank dat werkzaam is in en rondom de foodtruck of vendingmachine
...
4. Indien je een overval doet zonder duidelijke hostage en zonder wapen vast te hebben, dan mag de politie binnenvallen.
    !!! note "Uitzondering"
        Dit geldt niet voor overvallen waar een scenario aan vastzit, zoals bouwvakkers, vakkenvullers, etc. Dan moet dat scenario wel helemaal uitgewerkt zijn met bijbehorende papieren.
    !!! warning "Verplicht"
        Als starter van de overval moet je gedurende de hele overval een wapen vasthouden.
...
6. Er mag geen ESI aankoppelen bij een kleine bank, tenzij de politie ESI oproept omdat zij beschoten worden.
7. Als er een counter plaatsvindt, dan wordt er aangekoppeld op het aantal wapens. Bijvoorbeeld: 4 wapens is 4 eenheden. Ben je met minder, dan is dit eigen risico.
8. Per locatie mag maximaal een setup geplaatst worden. Per setup mogen maximaal 3 mensen aanwezig zijn die mogen schieten tijdens de setup. Tijdens een setup mag enkel op banden geschoten worden.
