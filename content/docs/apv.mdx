...
* Op het eiland mag tijdens een eiland fight 1 bearcat per groep worden gebruikt. Je mag meerdere bezitten maar maximaal 1 gebruiken tijdens een fight.
...
* Per locatie mag maximaal 1 setup geplaatst worden. Per setup mogen maximaal 3 mensen aanwezig zijn die tijdens de setup mogen schieten. Tijdens een setup mag enkel op banden geschoten worden.
